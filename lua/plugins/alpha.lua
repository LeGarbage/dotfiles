return {
    {
        ...
        config = function()
            ...
            if vim.o.lines >= 40 then
                for _, line in ipairs(btw_text) do
                    table.insert(neovim_text, line)
                end
            end
            ...
            dashboard.section.buttons.val = {
                ...
                dashboard.button("s", " Last Session", "<cmd>source Session.vim<cr>"),
                dashboard.button("c", "󰒓 Open Config", "<cmd>e $MYVIMRC<cr>"),
            ...
            local shrek = {
                ...
                [[Oh, you both have layers. Oh.  You know, not everybody likes]],
                ...
                [[open. Believe me, Donkey, if it was me, you'd be dead.  It's]],
            ...
            local quote = {
                ...
                val = {
                    {
                        type = "text",
                        val = string.format([["%s"]], shrek[math.random(#shrek)]),
            ...
            local top_padding = math.max(vim.o.lines - #neovim_text - 17, 0)
            alpha.setup({
                layout = {
