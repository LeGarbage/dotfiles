...
define_highlight('CursorLineNr', cyan, gray2, 'none')
...
define_highlight('NormalFloat', gray4, gray2, '')
define_highlight('FloatBorder', pink, '', '')
...
define_highlight('SpellCap', yellow, gray2, 'underline')
define_highlight('SpellBad', red, gray2, 'underline')
