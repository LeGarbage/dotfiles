...
define_highlight('LineNr', gray4, '', '')
define_highlight('LspInlayHint', gray4, '', '')
define_highlight('MatchParen', '', gray4, 'none')
...
define_highlight('QuickFixLine', 'NONE', gray3, 'bold')
...
define_highlight('SpellCap', '', '', 'undercurl guisp=' .. warning)
define_highlight('SpellBad', '', '', 'undercurl guisp=' .. error)
define_highlight('SpellRare', '', '', 'undercurl guisp=' .. info)
define_highlight('SpellLocal', '', '', 'undercurl guisp=' .. hint)
...
define_highlight("Winbar", gray5, gray2, 'none')
define_highlight("WinbarNC", gray4, gray2, 'none')
