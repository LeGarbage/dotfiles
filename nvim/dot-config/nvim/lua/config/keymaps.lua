...
vim.keymap.set("n", "<leader>w", "<C-w>", { desc = "Alias for <C-w>" })
...
vim.keymap.set("n", "<leader>fb", builtin.current_buffer_fuzzy_find, { desc = "Telescope in current buffer" })
...
vim.keymap.set("n", "<leader>fD", builtin.diagnostics, { desc = "Telescope diagnostics (workspace)" })
